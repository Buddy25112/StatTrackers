    ...
    while wait(_G.Intervals) do
            ...
            ["embeds"] = {
                {
                    ...
                    ["fields"] = {},
                    ["footer"] = {
                        ["text"] = "Updates every " .. _G.Intervals .. " Seconds | Mining Simulator 2"
                    },
                    ['timestamp'] = timestamp,
                }
            }
        ...
        if _G.EggCount == true then
            local EggsCountEmbed = {
            	["name"] = "Egg Count Data",
            	["value"] = abb(count1) .. " Eggs have been hatched! | *+" .. abb(EggsHatchedPer1) .. " in the last " .. _G.Intervals .. " seconds*",
            	["inline"] = false
        	    }
	    ...
	    if _G.RebirthCount == true then
	        local RebirthsCountEmbed = {
				...
				["value"] = abb(count22) .. " Rebirths have been counted! | *+" .. abb(RebirthsPer1) .. " in the last " .. _G.Intervals .. " seconds*",
				["inline"] = false
	            }
	    ...
	    if _G.BlocksCount == true then
	        local BlocksCountEmbed = {
				...
				["value"] = abb(count33) .. " Blocks have been mined! | *+" .. abb(BlocksPer1) .. " in the last " .. _G.Intervals .. " seconds*",
				["inline"] = false
	            }
